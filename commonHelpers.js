import"./assets/styles-0d479da7.js";import"./assets/vendor-d8b4b001.js";import{r as o}from"./assets/footer-2d6ae96d.js";const t="favorite-exercises",f=e=>{const s=localStorage.getItem(t);if(s){const r=[...JSON.parse(s).filter(i=>i._id!==e._id),e];localStorage.setItem(t,JSON.stringify(r))}else localStorage.setItem(t,JSON.stringify([e]))},m=e=>{const s=localStorage.getItem(t);if(s){const r=JSON.parse(s).filter(i=>i._id!==e);localStorage.setItem(t,JSON.stringify(r))}},d=()=>{const e=localStorage.getItem(t);return e?JSON.parse(e):[]},p=e=>{const s=localStorage.getItem(t);return s?JSON.parse(s).some(r=>r._id===e):!1},u={add:f,remove:m,getAll:d,isFavorite:p};function x(e){if(e.value){e.value="";return}console.error("function clearElement:","Only works with input elements")}function S(e,s){if(e.innerHTML="",!s){x(o.searchInputElement),e.insertAdjacentHTML("afterbegin",`<li class="list-item-error">
